...
export const rkapTypeOptions: SelectOption [] = [
  ...
  {value: 8 , label: "PEMBELAJARAN DAN PENGEMBANGAN SDM - Pelatihan & Pengembangan Kompetensi Karyawan (Learning Wallet)"},
  {value: 9 , label: "PEMBELAJARAN DAN PENGEMBANGAN SDM - Pelatihan & Pengembangan Kompetensi Karyawan (In House Training) - Karyawan Pimpinan - Soft Competency"},
  {value: 10 , label: "PEMBELAJARAN DAN PENGEMBANGAN SDM - Pelatihan & Pengembangan Kompetensi Karyawan (In House Training) - Karyawan Pimpinan - Hard Competency"},
  {value: 11 , label:"PEMBELAJARAN DAN PENGEMBANGAN SDM - Pelatihan & Pengembangan Kompetensi Karyawan (In House Training) - Millenial Leader Program"},
  ...
  {value: 19 , label: "PEMBELAJARAN DAN PENGEMBANGAN SDM - Kursus Jabatan (Leadership Development Program) - Karyawan Pimpinan; Talent Pool - Leadership Development Program II" },
  {value:20 , label:"PEMBELAJARAN DAN PENGEMBANGAN SDM - Kursus Jabatan (Leadership Development Program) - Karyawan Pimpinan; Talent Pool - Leadership Development Program III"},
  {value: 21, label:"PEMBELAJARAN DAN PENGEMBANGAN SDM - Kursus Jabatan (Leadership Development Program) - Karyawan Pelaksana - PPKM (Kepemimpinan Mandor)"},
  {value:22 , label:"PEMBELAJARAN DAN PENGEMBANGAN SDM - Kursus Jabatan (Leadership Development Program) - Karyawan Pelaksana - PPTM (Teknis Mandor)"},
  {value: 23, label:"PEMBELAJARAN DAN PENGEMBANGAN SDM - Program Sertifikasi Kompetensi Khusus Jabatan - Karyawan Pimpinan"},
  {value: 24, label:"PEMBELAJARAN DAN PENGEMBANGAN SDM - Program Sertifikasi Kompetensi Khusus Jabatan - Karyawan Pelaksana"},
  {value:25 , label:"PEMBELAJARAN DAN PENGEMBANGAN SDM - Program Study Banding (Benchmarking) - Dalam Negeri"},
  {value:26 , label:"PEMBELAJARAN DAN PENGEMBANGAN SDM - Program Study Banding (Benchmarking) - Luar Negeri"},
  {value:27 , label:"PEMBELAJARAN DAN PENGEMBANGAN SDM - Perjalanan Dinas - Karyawan Pimpinan"},
  {value: 28, label:"ASSESSMENT - Karyawan Pimpinan"},
  {value:29 , label:"PEMBELAJARAN DAN PENGEMBANGAN SDM - Perjalanan Dinas - Karyawan Pelaksana"},
  {value: 30, label:"ASSESSMENT - Karyawan Pelaksana"},
  {value:31 , label:"REKRUTMEN - Karyawan Pimpinan"},
  {value: 32, label:"REKRUTMEN - Karyawan Pelaksana"},
  {value: 33, label:"REKRUTMEN - Program On Boarding Karyawan Baru - Karyawan Pimpinan"},
  {value:34 , label:"REKRUTMEN - Program On Boarding Karyawan Baru - Karyawan Pelaksana"},
  {value: 35, label:"BIAYA PROGRAM INTERNALISASI BUDAYA (CORPORATE CULTURE)"},
  {value: 36, label:"BIAYA KONSULTANSI PENGEMBANGAN SDM"},
  {value:37 , label:"BIAYA INOVASI DAN RISET"},
  {value: 38, label:"BIAYA PENGEMBANGAN SDM LAIN-LAIN"}
]
