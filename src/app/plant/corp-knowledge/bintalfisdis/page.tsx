...
const BintalfisdiCKLPage = () => {
  ...
  const handleSubmit = async () => {
    ...
    await axios.put(
      `http://localhost:8080/api/ckp/user/ckl-bintalfisdis`,
      {
        ckl_bintalfisdis: editorContent,
        ...
        <>
          <div className="mb-8 flex justify-between border-b border-gray-200 pb-4 dark:border-gray-700">
            <div>
              <h2 className="text-3xl font-bold text-gray-800 dark:text-white">
                Isi CKL Bintalfisdis Anda
              </h2>
              <p className="mt-1 text-gray-500 dark:text-gray-400">
                Lengkapi form berikut untuk menambahkan Bintalfisdis terhadap
          ...
          <div className="w-full rounded-lg bg-white p-8 shadow-lg dark:border-strokedark dark:bg-boxdark">
            <QuillEditor
              ...
              placeholder="Tulis deskripsi CKL Bintalfisdis Anda di sini..."
              maxWords={MAX_WORDS}
              maxChars={MAX_CHARS}
            />
          </div>
...
export default BintalfisdiCKLPage;
