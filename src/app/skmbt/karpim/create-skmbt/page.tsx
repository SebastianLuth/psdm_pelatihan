...
const FormAddSKMBTKarpimPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await axios.post(`${baseUrl}/api/skmbt/karpim/admin`, data, {
        headers: {
          ...
          <div className="mb-8 flex justify-between border-b border-gray-200 pb-4 dark:border-gray-700">
            <div>
              ...
              <p className="mt-1 text-gray-500 dark:text-gray-400">
                Lengkapi form berikut untuk menambahkan Wasiat Pra Pensiun dari Karpel
                baru
              </p>
            </div>
            <Breadcrumb />
...
export default FormAddSKMBTKarpimPage;
