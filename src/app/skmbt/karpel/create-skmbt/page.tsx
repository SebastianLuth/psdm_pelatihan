...
const FormAddSKMBTKarpelPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      data.append("niksap", formData.jabatan);
      data.append("pdf_skmbt", file);

      await axios.post(`${baseUrl}/api/skmbt/admin`, data,{
        headers: {
        ...
        <DefaultLayout>
          <div className="mb-8 flex justify-between border-b border-gray-200 pb-4 dark:border-gray-700">
            <div>
              ...
              Tambah Wasiat Pra Pensiun dari Karpel
              </h2>
...
export default FormAddSKMBTKarpelPage;
