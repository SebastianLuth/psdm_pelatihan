...
const SKMBTDataKarpelPage = () => {
    ...
    const handleDeleteSkmbt = async (id: number) => {
        try {
            ...
            console.error(error);
            Swal.fire("Gagal!", "Terjadi kesalahan saat menghapus data SKMBT.", "error");
        }
    };
    ...
    const fetchDataSkmbt = useCallback( async () => {
        try {
            ...
            setSkmbtData(result?.data.data.map((item: SkmbtData) => {
                return {
                    ...item,
            ...
            <>
                ...
                <div className="bg-white relative overflow-hidden rounded-xl border border-gray-300 shadow-xl backdrop-blur-lg dark:border-gray-700 dark:bg-gray-900/70">
                    ...
                    <div className="flex items-center justify-between space-x-4 py-4">
                        ...
                        <Link href="/skmbt/karpel/create-skmbt" className="flex items-center justify-center rounded-lg bg-blue-500 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300">Tambah Wasiat Pra Pensiun Karpel</Link>
                    </div>
...
export default SKMBTDataKarpelPage