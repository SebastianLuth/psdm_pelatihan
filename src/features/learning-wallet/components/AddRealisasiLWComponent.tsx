...
import { submitRealisasiLearningWallet } from "@/service/learningWallet";
import { useRouter } from "next/navigation";
import { useRef, useState } from "react";
import Swal from "sweetalert2";

export const AddRealisasiLearningWalletComponent = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const result = await submitRealisasiLearningWallet(
        formData,
        {
      ...
      if (result.success) {
        ...
        await Swal.fire({
          title: "Success!",
          text: "Berhasil Menambahkan Realisasi LW",
          icon: "success",
