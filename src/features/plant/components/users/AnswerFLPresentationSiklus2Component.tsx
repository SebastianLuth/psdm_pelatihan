...
export const Siklus2PresentationFLComponent = () => {
  ...
  const handleSubmit = async () => {
    ...
    await axios.put(
      `${baseUrl}/api/ckp/user/fl/presentasi2`,
      {
        presentasi2: editorContent,
      ...
      <div className="mb-8 flex justify-between border-b border-gray-200 pb-4 dark:border-gray-700">
        <div>
          <h2 className="text-3xl font-bold text-gray-800 dark:text-white">
            Field Learning Presentation pada Siklus 2
          </h2>
          <p className="mt-1 text-gray-500 dark:text-gray-400">
            Lengkapi form berikut untuk menambahkanField Learning Presentation
            pada Siklus 2 anda
          </p>
        </div>
      </div>
