...
export const AnswerDireksiCKLComponent = () => {
    ...
    <>
      <div className="mb-8 flex justify-between border-b border-gray-200 pb-4 dark:border-gray-700">
        <div>
          <h2 className="text-3xl font-bold text-gray-800 dark:text-white">
            Isi CKL Direksi Anda
          </h2>
          <p className="mt-1 text-gray-500 dark:text-gray-400">
            Lengkapi form berikut untuk menambahkan Direksi terhadap Corporate
            Knowledge Learning anda
          </p>
        </div>
      </div>
      <div className="w-full rounded-lg bg-white p-8 shadow-lg dark:border-strokedark dark:bg-boxdark">
        <QuillEditor
          ...
          placeholder="Tulis deskripsi CKL Direksi Anda di sini..."
          maxWords={MAX_WORDS}
          maxChars={MAX_CHARS}
        />
      </div>
