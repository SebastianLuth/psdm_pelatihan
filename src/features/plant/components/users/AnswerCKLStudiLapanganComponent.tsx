...
export const StudiLapanganCKLComponent = () => {
  ...
  const handleSubmit = async () => {
    ...
    await axios.put(
      `${baseUrl}/api/ckp/user/ckl-studi-lapangan`,
      {
          ...
          <div className="mb-8 flex justify-between border-b border-gray-200 pb-4 dark:border-gray-700">
            <div>
              <h2 className="text-3xl font-bold text-gray-800 dark:text-white">
                Isi CKL Studi Lapangan Anda
              </h2>
              <p className="mt-1 text-gray-500 dark:text-gray-400">
                Lengkapi form berikut untuk menambahkan CKL Studi Lapangan terhadap
