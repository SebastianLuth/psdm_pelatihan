...
export const ImplementationInovationPAComponent = () => {
  ...
  const handleSubmit = async () => {
    ...
    Swal.fire({
      ...
      router.push("/plant/project-assignment");
    });
  };
      ...
      <div className="mb-8 flex justify-between border-b border-gray-200 pb-4 dark:border-gray-700">
        <div>
          <h2 className="text-3xl font-bold text-gray-800 dark:text-white">
            Isi Implementasi Inovatif Anda
          </h2>
          <p className="mt-1 text-gray-500 dark:text-gray-400">
            Lengkapi form berikut untuk menambahkan Implementasi Inovatif
            terhadap project assignment anda
          </p>
        </div>
      </div>
