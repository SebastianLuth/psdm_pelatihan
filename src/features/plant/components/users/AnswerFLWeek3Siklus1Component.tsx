...
export const Siklus1Week3FLComponent = () => {
  ...
  const handleSubmit = async () => {
    ...
    await axios.put(
      `${baseUrl}/api/ckp/user/fl/minggu3`,
      {
        minggu3: editorContent,
      ...
      <div className="mb-8 flex justify-between border-b border-gray-200 pb-4 dark:border-gray-700">
        <div>
          <h2 className="text-3xl font-bold text-gray-800 dark:text-white">
            Field Learning Siklus 1 pada Week 3
          </h2>
          <p className="mt-1 text-gray-500 dark:text-gray-400">
            Lengkapi form berikut untuk menambahkan Field Learning week 3 anda
          </p>
        </div>
      </div>
