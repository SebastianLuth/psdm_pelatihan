...
const TableAssessmentBod2: React.FC = () => {
    return (
        <div className="p-6 bg-gray-50 font-sans">
            <h2 className="text-xl font-semibold text-gray-700 mb-2">Data Assessment 2 & 3</h2>
            <p className="text-gray-600 mb-4">Halaman ini untuk melihat data assessment 2 & 3.</p>
...
export default TableAssessmentBod2;